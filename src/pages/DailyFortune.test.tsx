...
describe('DailyFortune Page', () => {
  ...
  beforeEach(() => {
    ...
    (fortuneStoreModule.useFortuneStore as unknown as ReturnType<typeof vi.fn>).mockReturnValue({
      fortune: mockFortuneData,
      isLoading: false,
      checkAndFetch: mockCheckAndFetch,
    });

    (userStoreModule.useUserStore as unknown as ReturnType<typeof vi.fn>).mockReturnValue({
      profile: mockProfile,
    });
  });

...
export const InsightCard: React.FC = () => {
  return (
    <div className="px-2 mt-4">
      <div className="bg-pixel-card border border-pixel-border rounded-xl p-3 flex gap-4 items-center relative overflow-hidden">
        {/* Left Image Box */}
        ...
        <div className="flex-1 flex flex-col justify-between h-24 py-1">
          <div>
            <h3 className="text-white font-bold text-lg leading-tight mb-1">洞悉命理奥秘, <br/>揭开命运潜藏密码</h3>

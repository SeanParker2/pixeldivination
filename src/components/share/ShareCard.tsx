    ...
    >
      ...
      <div className="p-6 pb-8 z-10">
        ...
        <div className="flex items-center justify-between mt-4 pt-4 border-t border-white/10">
          ...
          {/* QR Code */}
          <div className="w-12 h-12 bg-white p-0.5 rounded overflow-hidden">
            <img 
              src={`https://api.qrserver.com/v1/create-qr-code/?size=100x100&data=${encodeURIComponent('https://pixeldivination.app')}`}
              alt="QR Code"
              ...
              onError={(e) => {
                ...
                if (parent) {
                  parent.innerHTML = `
                    <div class="w-full h-full border-2 border-black relative">
                      ...
                      <div class="absolute bottom-3 right-3 w-2 h-2 bg-black rounded-full"></div>
                    </div>
                  `;
                }
              }}
